            ...
            <article className="projects__card">
              ...
              <div className="projects__modal">
                <div>
                  ...
                  <a href="http://manikandanuki.unaux.com/?i=1" target="_blank" className="projects__button button button__small">
                    <i className="ri-link" />
                  </a>
                </div>
              </div>
            ...
            <article className="projects__card">
              ...
              <div className="projects__modal">
                <div>
                  ...
                  <a href="https://kitecareer.com/Surabhiconstruction/" target="_blank" className="projects__button button button__small">
                    <i className="ri-link" />
                  </a>
                </div>
              </div>
            ...
            <article className="projects__card">
              ...
              <div className="projects__modal">
                <div>
                  ...
                  <a href="http://www.transcloudservices.com/index.html" target="_blank" className="projects__button button button__small">
                    <i className="ri-link" />
                  </a>
                </div>
              </div>
